...
class MonteCarloSimulator:
    ...
    def simulate_season(
        ...
        # Expose raw simulated distributions so callers can add locked-in
        # points from completed races before computing title probabilities.
        self.last_all_points = all_points
